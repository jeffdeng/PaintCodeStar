...
+ (void)drawStarWithFrontColor: (UIColor*)frontColor
{
    ...
    [bezierPath addCurveToPoint: CGPointMake(12.07, 4.27) controlPoint1: CGPointMake(15, 0) controlPoint2: CGPointMake(13.48, 2.22)];
    [bezierPath addCurveToPoint: CGPointMake(9.71, 7.72) controlPoint1: CGPointMake(10.85, 6.06) controlPoint2: CGPointMake(9.71, 7.72)];
    [bezierPath addLineToPoint: CGPointMake(0.73, 10.36)];
    [bezierPath addLineToPoint: CGPointMake(6.44, 17.78)];
    [bezierPath addLineToPoint: CGPointMake(6.18, 27.14)];
    [bezierPath addLineToPoint: CGPointMake(15, 24)];
    [bezierPath addLineToPoint: CGPointMake(23.82, 27.14)];
    [bezierPath addLineToPoint: CGPointMake(23.56, 17.78)];
    [bezierPath addLineToPoint: CGPointMake(29.27, 10.36)];
    [bezierPath addLineToPoint: CGPointMake(20.29, 7.72)];
    [bezierPath addLineToPoint: CGPointMake(15, 0)];
...
+ (void)drawFiveStarWithFrame: (CGRect)frame fillColor: (UIColor*)fillColor backgroundColor: (UIColor*)backgroundColor frontColor: (UIColor*)frontColor value: (CGFloat)value
{
    ...
    //// backgroud Drawing
    UIBezierPath* backgroudPath = [UIBezierPath bezierPathWithRect: CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame), CGRectGetWidth(frame), CGRectGetHeight(frame))];
    [backgroundColor setFill];
    [backgroudPath fill];


    //// fill Drawing
    UIBezierPath* fillPath = [UIBezierPath bezierPathWithRect: CGRectMake(0, 0, expression, CGRectGetHeight(frame))];
    [fillColor setFill];
    [fillPath fill];
    ...
    //// Group
    {
        ...
        [StarKIT drawStarWithFrontColor: frontColor];
